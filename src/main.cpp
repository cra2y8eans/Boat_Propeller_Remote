...
void setup() {
  ...
  xTaskCreate(sendData, "sendData", 1024 * 10, NULL, 3, NULL);
  xTaskCreate(connection_state_check, "esp_now_connection_check", 1024 * 10, NULL, 2, NULL);
  xTaskCreate(buttonTask, "buttonTask", 1024 * 10, NULL, 1, NULL);
  xTaskCreate(batteryCheck, "batteryTask", 1024 * 10, NULL, 1, NULL);
}
